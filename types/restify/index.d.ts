...
/// <reference types="node" />
    ...
    export namespace plugins {
        ...
        /**
         * Parses URL query paramters into `req.query`. Many options correspond directly to option defined
         * for the underlying [qs.parse](https://github.com/ljharb/qs)
         */
        ...
        interface MetricsCallbackOptions {
             ...
             *
             * If connectionState is either 'close' or 'aborted', then the statusCode is not applicable since
             * the connection was severed before a response was written.
             */
